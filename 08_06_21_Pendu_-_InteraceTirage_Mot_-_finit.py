...
def ecran2():
    ...
    # Frame 5
    titre_choixTheme = Label(fra_5, text='Choisissez Une Thème', font=font.title2, bg=couleur.fen_bg, fg=couleur.title2)
...
##    fra_11_clavier.grid(row=2, column=1)
    ...
    list_Tiret = mot_Tir
    print(list)
##    list_Tiret = ["___"*len(mot_Ran)]
    tiret_affi = ""
    for i in list_Tiret:
        tiret_affi += i
        tiret_affi += " "
    tiret_Label = Label(fra_9_tiret, text = tiret_affi, font=("Berlin Sans FB", 20), bg=couleur.fen_bg)
...
##    bravo_img =
    ...
    changer_Theme_Bouton = Button(fra_15, text="Changer La Thème", font=font.bou2, command=changerTheme)
    exit_Bouton = Button(fra_15, text = "Quit", font=font.bou2, command=fen.destroy)
