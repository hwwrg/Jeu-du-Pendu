...
=todo=
1. règles de jeu
2. font bon_Mot_Label <-- longueur maximum des mots
3. font  tiret_Label <--> longueur maximum des mots
4. fonction essaies restants
...
def hangman(compteur):
    ...
    dico_Hg = {1:"hg1.png", 2:"hg2.png", 3:"hg3.png",4:"hg4.png",
